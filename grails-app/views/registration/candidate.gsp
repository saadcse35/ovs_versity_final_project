...
<head>
    ...
    <title>অনলাইন ভোটিং সিস্টেম | প্রার্থী রেজিষ্ট্রেশন</title>
</head>
        ...
        <div class="row justy-content-center">
            <div class="col-lg-12 col-sm-6 col-md-6">
                <div class="text-center feature-block">
                    <div class="card">
                        <h5 class="card-header" style="background-color: #21c87a; color: white;">ব্যাক্তিগত তথ্য</h5>
                    ...
                    <div class="card">
                        <h5 class="card-header" style="background-color: #21c87a; color: white;">পারিবারিক তথ্য</h5>
                    ...
                    <div class="card">
                        <h5 class="card-header" style="background-color: #21c87a; color: white;">স্থায়ী ঠিকানা</h5>
                    ...
                    <div class="card">
                        <h5 class="card-header" style="background-color: #21c87a; color: white;">বর্তমান ঠিকানা</h5>
