						...
						<div class="card-body">
								...
								<table class="table table-hover text-nowrap">
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="code-label">
												<g:fieldValue bean="${partyInstance}" field="code"/>
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="name-label">
												<g:fieldValue bean="${partyInstance}" field="name"/>
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="shortName-label">
												<g:fieldValue bean="${partyInstance}" field="shortName"/>
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="regDate-label">
												<g:formatDate date="${partyInstance?.regDate}" />
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="partyDescription-label">
												<g:fieldValue bean="${partyInstance}" field="partyDescription"/>
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="isActive-label">
												<g:formatBoolean boolean="${partyInstance?.isActive}"
																 true="Yes" false="No" />
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="status-label">
												<g:fieldValue bean="${partyInstance}" field="status"/>
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="sortOrder-label">
												<g:fieldValue bean="${partyInstance}" field="sortOrder"/>
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="dateCreated-label">
												<g:formatDate date="${partyInstance?.dateCreated}" />
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="lastUpdated-label">
												<g:formatDate date="${partyInstance?.lastUpdated}" />
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="createdByUserId-label">
												<g:link controller="user" action="show" id="${partyInstance?.createdByUserId?.id}">
													${partyInstance?.createdByUserId?.encodeAsHTML()}
												</g:link>
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="lastUpdatedByUserId-label">
												<g:link controller="user" action="show" id="${partyInstance?.lastUpdatedByUserId?.id}">
													${partyInstance?.lastUpdatedByUserId?.encodeAsHTML()}
												</g:link>
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="createdBySessionId-label">
												<g:link controller="accessLog" action="show" id="${partyInstance?.createdBySessionId?.id}">
													${partyInstance?.createdBySessionId?.encodeAsHTML()}
												</g:link>
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="lastUpdatedBySessionId-label">
												<g:link controller="accessLog" action="show" id="${partyInstance?.lastUpdatedBySessionId?.id}">
													${partyInstance?.lastUpdatedBySessionId?.encodeAsHTML()}
												</g:link>
											</span>
									...
									<tr>
										...
										<td>
											...
											<span class="property-value" aria-labelledby="imagePath-label">
												<g:fieldValue bean="${partyInstance}" field="imagePath"/>
											</span>
							...
							<g:form url="[resource:partyInstance, action:'delete']" method="DELETE">
								<fieldset class="buttons">
									<g:link class="btn btn-primary edit" action="edit" resource="${partyInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
