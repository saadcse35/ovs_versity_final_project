...
/* Date stuff that doesn't belong in datelib common.core
----------------------------------------------------------------------------------------------------------------------*/
...
function reduce (state, action, calendar) {
    ...
    // console.common.log(action.type, nextState)
    return nextState;
}
...
/*
Triggers events and adds/removes common.core classNames when the user's pointer
